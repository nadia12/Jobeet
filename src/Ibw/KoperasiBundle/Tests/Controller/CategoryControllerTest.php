...
class CategoryControllerTest extends WebTestCase
{
    ...
    public function testShow()
    {
        ...
        $categories = $this->em->getRepository('IbwKoperasiBundle:Category')->getWithJobs();
        ...
        foreach($categories as $category) {
            ...
            $this->assertEquals('Ibw\KoperasiBundle\Controller\CategoryController::showAction', $client->getRequest()->attributes->get('_controller'));
            $this->assertEquals($category->getSlug(), $client->getRequest()->attributes->get('slug'));
 
            $jobs_no = $this->em->getRepository('IbwKoperasiBundle:Job')->countActiveJobs($category->getId()); 
