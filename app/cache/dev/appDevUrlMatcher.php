    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/job')) {
            ...
            if (preg_match('#^/job/(?P<company>[^/]++)/(?P<location>[^/]++)/(?P<token>\\w+)/(?P<position>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ibw_job_preview')), array (  '_controller' => 'Ibw\\KoperasiBundle\\Controller\\JobController::previewAction',));
            }
            ...
            if (preg_match('#^/job/(?P<token>[^/]++)/publish$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ibw_job_publish')), array (  '_controller' => 'Ibw\\KoperasiBundle\\Controller\\JobController::publishAction',));
            }
            not_ibw_job_publish:
